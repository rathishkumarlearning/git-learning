...
import {
  ...
  Lightbulb, AlertTriangle, Play, Home, GitBranch
} from 'lucide-react';
import './index.css';
...
function App() {
  ...
  useEffect(() => {
    const saved = localStorage.getItem('git-learning-progress');
  ...
  const saveProgress = (lessonId) => {
    ...
    localStorage.setItem('git-learning-progress', JSON.stringify(updated));
  };
    ...
    <div className="app-container">
      ...
      <aside className={`sidebar ${sidebarOpen ? 'open' : ''}`}>
        <div className="sidebar-header">
          <div className="sidebar-logo"><GitBranch size={24} /></div>
      ...
      <main className="main-content">
        {currentView === 'home' && (
          <>
            <div className="hero">
              <div className="hero-badge"><GitBranch size={16} /><span>Git & GitHub Course</span></div>
              <h1 className="hero-title">Master<br /><span>Version Control</span></h1>
              <p className="hero-subtitle">Learn Git from scratch and become a collaboration pro. Track changes, work with teams, and deploy with confidence!</p>
            ...
            <div className="glass-card" style={{ textAlign: 'center' }}>
              ...
              <p style={{ color: 'var(--text-secondary)', marginBottom: '24px' }}>By the end, you'll be able to:</p>
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(150px, 1fr))', gap: '16px' }}>
                {['Git Basics', 'Branching', 'Merging', 'Pull Requests', 'GitHub Actions', 'CI/CD'].map((item) => (
